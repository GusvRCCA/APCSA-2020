...
A new private integer variable called incorrectCheckCount is needed

A new public void constructor setCount is needed that sets the incorrectCheckCount to zero is needed

A new public void constructor addCount is needed that adds one to the incorrectCheckCount is needed

A new public method that getCount returns the integer value of incorrectCheckCount is needed

By placing addCount before any time isValid returns false, the amount of times false is returned can be tracked
