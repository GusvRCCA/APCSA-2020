...
public class Pong extends Canvas implements KeyListener, Runnable
{
	...
	public Pong()
	{
		...
		ball = new Ball(rand.nextInt(350)+170,rand.nextInt(400)+150,10,10,Color.red,1,1);
		//ball = new BlinkyBall(rand.nextInt(350)+170,rand.nextInt(400)+150,10,10,Color.red,1,1);
		//ball = new SpeedUpBall(rand.nextInt(350)+170,rand.nextInt(400)+150,10,10,Color.green,1,1);
		
		leftPaddle = new Paddle(20,300,10,50,Color.blue,speed);
   ...
   public void paint(Graphics window)
   {
		...
		if(!(ball.getX()>=10 && ball.getX()<=780)){
			...
			ball = new Ball(rand.nextInt(350)+170,rand.nextInt(400)+150,10,10,Color.red,1,1);
			//ball = new BlinkyBall(rand.nextInt(350)+170,rand.nextInt(400)+150,10,10,ball.randomColor(),1,1);
			//ball = new SpeedUpBall(rand.nextInt(350)+170,rand.nextInt(400)+150,10,10,Color.green,1,1);
